...
const { listRequestTypes, createSubmission, getProgress, uploadDocument, removeDocument } = useChecklist()
...
async function beginChecklist() {
  ...
  try {
    ...
    window.history.replaceState({}, '', `/submit/${submission.id}`)
  } finally {
    ...
    <main class="body">
        ...
        <div class="section-body">
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input id="officeAffiliation" v-model="officeAffiliation" type="text" placeholder="College of Engineering" :disabled="!!submissionId" />
            </div>
            <div class="field">
      ...
      <section v-if="progress" class="card">
        <div class="card-toolbar">
          ...
          <span class="toolbar-hint" :class="{ complete: isComplete }">
            {{ progress.totalUploaded }}/{{ progress.totalRequired }} submitted
          </span>
        </div>
        ...
        <div v-if="isComplete" class="complete-banner">
          ✓ All requirements submitted — your checklist is complete.
        </div>

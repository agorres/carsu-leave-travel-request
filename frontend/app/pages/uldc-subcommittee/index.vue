...
const { listUldcSubcommitteeSubmissions } = useChecklist()
...
onMounted(async () => {
  try {
    submissions.value = await listUldcSubcommitteeSubmissions()
  } catch (e) {
...
<template>
  <div class="admin-shell">
    <header class="admin-topbar">
      <div class="admin-title">ULDC Sub-Committee — Requests</div>

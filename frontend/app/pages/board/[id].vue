...
const { getProgress, getDocumentDownloadUrl, boardApproveSubmission } = useChecklist()
    ...
    <main class="admin-body">
      ...
      <template v-else-if="progress">
        <section class="admin-card status-card" :class="`status-${progress.submission.status}`">
          ...
          <div v-if="isForBoard" class="screening-actions">
            <p class="muted">ULDC has approved every document for this request. Review the documents below, then record the Board's decision.</p>
